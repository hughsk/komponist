...
util.inherits(MPDClient, net.Socket);
...
MPDClient.prototype.write = function(data, encoding, callback, responseCallback) {
    ...
    if (utfData === 'noidle\n') {
        return net.Socket.prototype.write.call(this, data, encoding);
    }
    ...
    return net.Socket.prototype.write.apply(this, Array.prototype.slice.call(arguments, 0, 3));
};
